...
namespace Carpool.WebAPI.Migrations
{
    ...
    [Migration("20200705142024_PaymentModelTable")]
    partial class PaymentModelTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Carpool.WebAPI.Database.KorisniciUloge", b =>
                {
            ...
            modelBuilder.Entity("Carpool.WebAPI.Database.PaymentModel", b =>
                {
            ...
            modelBuilder.Entity("Carpool.WebAPI.Database.Uloge", b =>
                {
                    b.Property<int>("UlogaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Carpool.WebAPI.Database.KorisniciUloge", b =>
                {
                    ...
                    b.HasOne("Carpool.WebAPI.Database.Uloge", "Uloga")
                        .WithMany("KorisniciUloge")
